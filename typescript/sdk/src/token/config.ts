export enum TokenType {
  ...
  syntheticPausable = 'syntheticPausable',
  syntheticLSP7 = 'syntheticLSP7',
  syntheticLSP7Pausable = 'syntheticLSP7Pausable',
  syntheticLSP8 = 'syntheticLSP8',
  syntheticLSP8Pausable = 'syntheticLSP8Pausable',
  collateral = 'collateral',
  collateralVault = 'collateralVault',
  collateralVaultRebase = 'collateralVaultRebase',
  collateralPausable = 'collateralPausable',
  collateralLSP7 = 'collateralLSP7',
  collateralLSP7Pausable = 'collateralLSP7Pausable',
  collateralLSP8 = 'collateralLSP8',
  collateralLSP8Pausable = 'collateralLSP8Pausable',
  XERC20 = 'xERC20',
...
const isMovableCollateralTokenTypeMap = {
  ...
  [TokenType.collateralPausable]: true,
  [TokenType.collateralLSP7]: true,
  [TokenType.collateralLSP7Pausable]: true,
  [TokenType.collateralLSP8]: true,
  [TokenType.collateralLSP8Pausable]: true,
  [TokenType.native]: true,
  [TokenType.nativePausable]: true,
  ...
  [TokenType.syntheticPausable]: false,
  [TokenType.syntheticLSP7]: false,
  [TokenType.syntheticLSP7Pausable]: false,
  [TokenType.syntheticLSP8]: false,
  [TokenType.syntheticLSP8Pausable]: false,
} as const;
