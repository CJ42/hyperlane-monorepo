...
export enum TokenStandard {
  ...
  EvmHypNativePausable = 'EvmHypNativePausable',
  EvmHypCollateralPausable = 'EvmHypCollateralPausable',
  EvmHypLSP7Collateral = 'EvmHypLSP7Collateral',
  EvmHypLSP7CollateralPausable = 'EvmHypLSP7CollateralPausable',
  EvmHypLSP8Collateral = 'EvmHypLSP8Collateral',
  EvmHypLSP8CollateralPausable = 'EvmHypLSP8CollateralPausable',
  ...
  EvmHypSyntheticPausable = 'EvmHypSyntheticPausable',
  EvmHypLSP7Synthetic = 'EvmHypLSP7Synthetic',
  EvmHypLSP7SyntheticPausable = 'EvmHypLSP7SyntheticPausable',
  EvmHypLSP8Synthetic = 'EvmHypLSP8Synthetic',
  EvmHypLSP8SyntheticPausable = 'EvmHypLSP8SyntheticPausable',
...
export const TOKEN_STANDARD_TO_PROTOCOL: Record<TokenStandard, ProtocolType> = {
  ...
  EvmHypNativePausable: ProtocolType.Ethereum,
  EvmHypCollateralPausable: ProtocolType.Ethereum,
  EvmHypLSP7Collateral: ProtocolType.Ethereum,
  EvmHypLSP7CollateralPausable: ProtocolType.Ethereum,
  EvmHypLSP8Collateral: ProtocolType.Ethereum,
  EvmHypLSP8CollateralPausable: ProtocolType.Ethereum,
  ...
  EvmHypSyntheticPausable: ProtocolType.Ethereum,
  EvmHypLSP7Synthetic: ProtocolType.Ethereum,
  EvmHypLSP7SyntheticPausable: ProtocolType.Ethereum,
  EvmHypLSP8Synthetic: ProtocolType.Ethereum,
  EvmHypLSP8SyntheticPausable: ProtocolType.Ethereum,
...
export const EVM_TOKEN_TYPE_TO_STANDARD: Record<TokenType, TokenStandard> = {
  ...
  [TokenType.nativePausable]: TokenStandard.EvmHypNativePausable,
  [TokenType.collateralPausable]: TokenStandard.EvmHypCollateralPausable,
  [TokenType.collateralLSP7]: TokenStandard.EvmHypLSP7Collateral,
  [TokenType.collateralLSP7Pausable]:
    TokenStandard.EvmHypLSP7CollateralPausable,
  [TokenType.collateralLSP8]: TokenStandard.EvmHypLSP8Collateral,
  [TokenType.collateralLSP8Pausable]:
    TokenStandard.EvmHypLSP8CollateralPausable,
  ...
  [TokenType.syntheticPausable]: TokenStandard.EvmHypSyntheticPausable,
  [TokenType.syntheticLSP7]: TokenStandard.EvmHypLSP7Synthetic,
  [TokenType.syntheticLSP7Pausable]: TokenStandard.EvmHypLSP7SyntheticPausable,
  [TokenType.syntheticLSP8]: TokenStandard.EvmHypLSP8Synthetic,
  [TokenType.syntheticLSP8Pausable]: TokenStandard.EvmHypLSP8SyntheticPausable,
